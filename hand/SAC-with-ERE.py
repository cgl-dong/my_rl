...
class Actor(nn.Module):
    ...
    def reset_parameters(self):
        ...
        self.mu.weight.data.uniform_(hidden_init)
        self.log_std_linear.weight.data.uniform_(hidden_init)
...
parser.add_argument("-info", type=str,default="SAC-ERE", help="tensorboard test run information")
